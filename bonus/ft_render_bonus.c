...
//identificar los sprite y colocarlos
...
int ft_render_map(t_game *game)
{
    ...
    {
        x = 0; //para identificar el sprite lugo pasa a render sprite para colocar el sprite
   ...
   // ft_print_movements(game); //ponerlo luego para imprimir los movimientos
    return (0);
}
